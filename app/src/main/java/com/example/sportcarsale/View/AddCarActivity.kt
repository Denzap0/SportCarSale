...
class AddCarActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener,
    ...
    private fun addCar(){
        if (!checkParamsEnter()){
            ...
            val car = Car(brandSpinner.selectedItem.toString(),modelSpinner.selectedItem.toString(),
            ...
            roadTypeSpinner.selectedItem as RoadType, addCarViewModel.getCurrentUser()?.uid.toString(),imgUri.toString(),ownerDescriptionEditText.text.toString(),
